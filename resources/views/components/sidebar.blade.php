    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="{{ route('admin.group.index') }}"
                class="nav-link {{ Route::is('admin.group.index') ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
                @foreach ($groupUsers as $groupUser)
                    <li class="nav-item">
                        <a href="{{ route('admin.group.show', $groupUser->id) }}"  class="nav-link {{ Route::is('admin.group.show', ['id' => $groupUser->id]) ? 'active' : '' }}">
